...
globalkeys = gears.table.join(
    ...
    --awful.key({ modkey },            "r",     function () awful.spawn.with_shell("$HOME/.config/rofi/bin/powermenu") end,
    --          {description = "Run powermenu", group = "launcher"}),
    --awful.key({ modkey },            "a",     function () awful.spawn.with_shell("pactl set-default-sink (pactl list short sinks | cut -f 2 -- | rofi -dmenu)") end,
    --          {description = "Change sound sink", group = "launcher"}),

    --awful.key({},                "Print",     function () awful.spawn.with_shell("flameshot gui") end,
    --          {description = "Take screenshot", group = "tools"}),

    -- Media keys
    --awful.key({ }, "XF86Tools", function () awful.util.spawn("tauon") end),
    --awful.key({ }, "XF86AudioPlay", function () awful.util.spawn("playerctl -a play-pause") end),
